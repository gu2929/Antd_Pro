...
const AvatarView = ({ avatar,changeAvatar }) => (
  <Fragment>
    ...
    <Upload fileList={[]}  onChange={e=>{changeUrl(e,changeAvatar)}}>
...
class BaseView extends Component {
  ...
  getMessage = () => {
    ...
    let obj={};
    let getValue=this.props.form.getFieldsValue();
    obj.name=getValue.name;
    obj.avatar=currentUser.avatar;
    obj.email=getValue.email;
    obj.profile=getValue.profile;
    obj.city=getValue.geographic.city.label+getValue.geographic.province.label;
    obj.address=getValue.address;
    obj.phone=getValue.phone.split('-').join('');
    obj.status=200;
    this.props.changeMessage(obj)
  }
  render() {
    const {
      ...
      <div className={styles.baseView} ref={this.getViewDom}>
        <div className={styles.left}>
          <Form layout="vertical" onSubmit={this.handleSubmit} hideRequiredMark>
            ...
            <Button type="primary" onClick={this.getMessage}>
              <FormattedMessage
